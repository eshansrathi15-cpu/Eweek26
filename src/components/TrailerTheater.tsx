  ...
  return (
    <div className="min-h-screen bg-background text-foreground flex flex-col items-center justify-center p-6 spotlight vignette relative overflow-hidden">
      ...
      >
        ...
        {/* Video Player Frame */}
        <div className="relative aspect-video w-full border-4 border-primary/20 bg-black rounded-lg overflow-hidden shadow-[0_0_50px_rgba(var(--primary-rgb),0.2)]">
          <iframe
            className="absolute inset-0 w-full h-full"
            src="https://www.youtube.com/embed/YOUR_VIDEO_ID_HERE?autoplay=1&rel=0&modestbranding=1" 
