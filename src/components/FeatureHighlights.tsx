      ...
      <div className="max-w-6xl mx-auto px-6">
        ...
        >
          <div className="inline-flex items-center gap-2 px-3 py-1 border border-primary/50 bg-primary/10 backdrop-blur-sm">
            ...
            <span className="text-[9px] text-primary tracking-[0.4em] uppercase font-bold">
              v1.0_PROD
            </span>
        ...
        <motion.h2 
          ...
          whileInView={{ opacity: 1, y: 0 }}
          viewport={{ once: true }}
          className="text-5xl md:text-7xl font-bold tracking-tighter uppercase mb-16 text-foreground text-center"
        >
